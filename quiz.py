...
class QuizApp:
    ...
    def build_start_screen(self):
        ...
        self.diff_btn_colors = [(34, 211, 238, 120), (251, 146, 60, 120), (239, 68, 68, 120)]
        ...
        def on_resize(event=None):
            ...
            for i, label in enumerate(self.diff_btn_labels):
                ...
                draw.rectangle((0, 0, btn_w, btn_h), fill=self.diff_btn_colors[i], outline=None)
    ...
    def fetch_questions_from_gemini(self):
        try:
            ...
            for attempt in range(max_retries + 1):
                ...
                prompt_chunks = list(chunks(prompts, 5)) # Process in batches of 5
                ...
                for i, chunk in enumerate(prompt_chunks):
                    ...
                    # Pause between batches to stay under API rate limits
